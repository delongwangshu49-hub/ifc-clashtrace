...
- Main-flow and external boundary: commit locally and immediately fast-forward local `main`; before any public GitHub change, display the exact file set and obtain action-time authorization. Do not change Sites, access, permissions, keys, or later Gates.
