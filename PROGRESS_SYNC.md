...
- [x] No G2 publication candidate exceeds the 1 MiB review threshold (largest reviewed file was 84,445 bytes at audit start and remains below 88,000 bytes with the complete consistency-repair log).
