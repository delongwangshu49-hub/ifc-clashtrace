...
foreach ($contract in @("G0A", "G3A", "G3B", "G3C", "G3", "DG", "8 / 8", "1.00 / 1.00", "12 / 12", 'href="/app/#controlled-review" target="_blank" rel="noopener"', 'YouTube release and direct link', "data/generated/LICENSE.md")) {
