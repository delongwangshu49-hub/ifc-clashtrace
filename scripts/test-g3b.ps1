...
if ($proofByCase.G3B01.observed_status -ne "CLEAR" -or
    ...
    $proofByCase.G3B04.observed_status -ne "CLASH") {
...
if ($proofByCase.G3B05.observed_status -ne "CLEAR" -or
    $proofByCase.G3B06.observed_status -ne "CLEAR" -or
    $proofByCase.G3B07.observed_status -ne "CLASH") {
    throw "Thin-structure tolerance semantics failed."
}

if ($proofByCase.G3B08.observed_status -ne "CLEAR" -or
...
Write-Output "G3B_FAILURE_CLOSED=3/3"
